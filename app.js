...
document.write(
  ...
  " is" + score1,
  ".",
  "Percentage is " + percent1,
  "%",
  "<br>",
  "Score of " + name2,
  " is" + score2,
  ".",
  "Percentage is " + percent2,
  "%",
  "<br>",
  "Score of " + name3,
  " is" + score3,
  ".",
  "Percentage is " + percent3,
  "%"
);
...
document.write(
  "<br>" +
    ...
    "<br>" +
    "Element of index 2 is mango" +
    "<br>" +
    "Element of index 3 is orange" +
    "<br>" +
    "Element of index 4 is strawberry"
);
...
var userInput = prompt(
  "Welcome to XYZ Bakery.What do you want to order sir/mam?"
);
